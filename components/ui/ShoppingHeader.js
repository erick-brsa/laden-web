                ...
                <nav className={styles["main-nav"]}>
                    ...
                    <div className={styles["main-nav__menu"]}>
                        <ul className={styles["main-nav__list"]}>
                            ...
                            <li className={styles["main-nav__item"]}>
                                <a href="/cart" className="main-nav__link bottom-icon">
                                    <svg
                                        className={styles["main-nav__link-icon"]}
                                        width="24px"
                                        height="24px"
                            ...
                            <li className={styles["main-nav__item"]}>
                                <a href="/notifications" className="main-nav__link notification-icon">
                                    <svg
                                        className={styles["main-nav__link-icon"]}
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512"
                            ...
                            <li className={styles["main-nav__item"]}>
                                <a href="/profile" className="main-nav__link bottom-icon">
                                    <svg
                                        className={styles["main-nav__link-icon"]}
                                        width="24px"
                                        height="24px"
                    ...
                    <nav className={!isOpen ? styles["secondary-nav__menu"] : styles["show-secondary-nav__menu"]} id="secondary-nav">
                        <ul className={styles["secondary-nav__list"]}>
                            <li className={styles["secondary-nav__item-profile"]}>
                                <a href="/profile" className={styles["secondary-nav__link-profile"]}>
                            ...
                            <li className={styles["secondary-nav__item"]}>
                                <a href="/categories" className={styles["secondary-nav__link"]}>Categorías</a>
                            </li>
                            <li className={styles["secondary-nav__item"]}>
                                <a href="/offers" className={styles["secondary-nav__link"]}>Ofertas</a>
                            </li>
                            <li className={styles["secondary-nav__item"]}>
                                <a href="/team" className={styles["secondary-nav__link"]}>Conócenos</a>
                            </li>
                            <li className={styles["secondary-nav__item"]}>
                                <a href="/information/#services" className={styles["secondary-nav__link"]}>Servicios</a>
                            </li>
                            <li className={styles["secondary-nav__item"]}>
                                <a href="/history" className={styles["secondary-nav__link"]}>Historial</a>
                            </li>
                        </ul>
                    </nav>
                </div>
